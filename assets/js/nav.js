 ...
 * แก้ไข: ลบชื่อแบรนด์ส่วนเกินออก, จัดกึ่งกลางเป๊ะ, ไม่ล้นมือถือ
 */
document.addEventListener("DOMContentLoaded", function() {
    const navHTML = `
    <header class="fixed top-0 left-0 w-full z-[200] p-4 flex justify-center">
        <nav class="glass rounded-full px-6 py-3 flex justify-center items-center border border-white/10 shadow-2xl">
